...
![**Figure 1:** An example of a Try block with code from Module 5](https://github.com/sarao3/IntroToProg-Python-Mod07/blob/main/docs/Figure1.png "Try block example")    
