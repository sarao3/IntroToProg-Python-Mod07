...
![The pickle.load() function is used to read the data back into Python](https://github.com/sarao3/IntroToProg-Python-Mod07/blob/main/docs/Image6.jpeg "The pickle.load() function is used to read the data back into Python")  
