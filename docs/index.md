...
![The object and file are the two parameters passed into the pickle.dump() function.](https://github.com/sarao3/IntroToProg-Python-Mod07/blob/main/docs/Figure5.png "**Figure 5:** The object and file are the two parameters passed into the pickle.dump() function.")  
